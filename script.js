// https://createjs.com/#!/TweenJS/demos/sparkTable
            ...
            var jumpAmount = 115; // How high is the jump?
            var jumpTime = 266;

            var dead = false; // is the bird dead?
            var KEYCODE_SPACE = 32;     //usefull keycode
            var gap = 290;
            var masterPipeDelay = 80; // delay between pipes
            ...
            function handleComplete() {
                ...
                score = new createjs.Text("Score:", "70px 'flappy Bird")
                counter = new createjs.Text(0, "70px 'Flappy Bird'", "#ffffff");
                counterOutline = new createjs.Text(0, "70px 'Flappy Bird'", "#000000");
                counterOutline.outline = 5
                counterOutline.textAlign = 'top'
                counter.textAlign = 'top'
